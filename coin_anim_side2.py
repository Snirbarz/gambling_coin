...
class MyApp(ShowBase):
    ...
    def save(self,task):
        os.system("ffmpeg -y -framerate 30 -f image2 -i record/coin0"+self.side_1+'0'+self.side_2+'0'+self.side_2+"frame_%04d.png -q:v 1 -vcodec wmv2  coin0"+self.side_1+'0'+self.side_2+'0'+self.side_2+".avi")
        # Task.done
        # return Task.again
