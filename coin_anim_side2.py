...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.myInterval1 = self.model.hprInterval(1, Vec3(0,90,1260))
    ...
    def save(self,task):
        os.system("ffmpeg -y -framerate 30 -f image2 -i record/coin0"+self.side_1+'0'+self.side_2+'0'+self.side_2+"frame_%04d.png -q:a 2 -q:v 4 -vcodec wmv2 -acodec wmav2 coin0"+self.side_1+'0'+self.side_2+'0'+self.side_2+".avi")
        # Task.done
        # return Task.again
        # Define a procedure to move the camera.
    def record(self,task):
        base.movie(namePrefix='record/'+'coin0'+self.side_1+'0'+self.side_2+'0'+self.side_2+'frame', duration=3, fps=30, format='png')
